...
require github.com/heroiclabs/nakama-common v1.20.0
...
require (
	...
	github.com/blugelabs/bluge v0.1.8 // indirect
	...
	gopkg.in/natefinch/lumberjack.v2 v2.0.0-20190411184413-94d9e492cc53 // indirect
